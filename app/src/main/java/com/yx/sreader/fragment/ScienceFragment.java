...
public class ScienceFragment extends Fragment {
    ...
    private String dbname = "Science";
    private static List<String> listbookinfo = WelcomeActivity.getListbookinfo()[5];
    ...
    public static ScienceFragment newInstance(){
        ScienceFragment pagerFragment = new ScienceFragment();
