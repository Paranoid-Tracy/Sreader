...
public class InspirationalFragment extends Fragment {
    ...
    private String dbname = "Inspirational";
    private static List<String> listbookinfo = WelcomeActivity.getListbookinfo()[3];
    private static boolean IsInNetwork = WelcomeActivity.isInNetwork();
    private static Handler handler = new Handler();
    private String info;
    private ReentrantLock lock = new ReentrantLock();

    public static InspirationalFragment newInstance(){
        InspirationalFragment pagerFragment = new InspirationalFragment();
