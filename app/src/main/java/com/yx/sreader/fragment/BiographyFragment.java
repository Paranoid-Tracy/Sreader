...
public class BiographyFragment extends Fragment {
    ...
    private String dbname = "Biography";
    private static List<String> listbookinfo = WelcomeActivity.getListbookinfo()[4];
    ...
    public static BiographyFragment newInstance(){
        BiographyFragment pagerFragment = new BiographyFragment();
